        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <span class="mt-3">{{fullNames}}</span>
                    <button type="button" class="layout-topbar-action">
                        <i class="pi pi-user"></i>
                        <span>Profile</span>
                    </button>
                    <button pTooltip="Cerrar sesión" tooltipPosition="right"  class="p-link layout-topbar-button" (click)="logout()">
...
export class AppTopbar {
    ...
    fullNames!: string | boolean;

    constructor(public layoutService: LayoutService, private tokenservice: TokenServiceService) {}
    ...
    toggleDarkMode() {
       ...
       ngOnInit(): void {
        this.fullNames = this.tokenservice.getUser();
      }
